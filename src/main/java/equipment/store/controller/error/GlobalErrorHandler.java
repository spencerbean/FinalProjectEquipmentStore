package equipment.store.controller.error;
...
public class GlobalErrorHandler {
	...
	// Catches Exception Message NSEE and sets HTTP response code to 404 (Not Found) + some details
	...
	// Construct Exception Message by extracting HTTP status code's reason phrase and value, timestamp, and URI
